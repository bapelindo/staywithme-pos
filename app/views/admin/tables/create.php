    ...
    <div class="bg-white p-6 rounded-lg shadow-md border border-slate-200">
        <form action="<?= UrlHelper::baseUrl('/admin/tables/store') ?>" method="POST" novalidate>
             ...
             <div class="mb-6">
                  ...
                  <p class="text-xs text-slate-500 mt-1">Hilangkan centang jika meja tidak digunakan.</p>
             </div>
             ...
             <div class="flex justify-end space-x-3 border-t border-slate-200 pt-5 mt-5">
                 ...
                 <button type="submit" class="bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-bold py-2 px-4 rounded-lg transition shadow-md">Simpan Meja</button>
             </div>
        </form>
    </div>
</div>