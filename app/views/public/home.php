<?php
// File: app/Views/public/home.php (Konten Utama Halaman Beranda - DENGAN FIX WRAPPER SLIDER)
use App\Helpers\SanitizeHelper;
use App\Helpers\UrlHelper;
use App\Helpers\NumberHelper;

// Data dari Controller (jika ada)
// $pageTitle sudah di-set oleh layout
    ...
    <div aria-hidden="true" class="absolute bottom-1/4 right-10 w-20 h-20 rounded-full bg-accent-secondary/10 blur-2xl animate-pulse delay-500"></div>
     ...
     <div class="container mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center relative z-10">
        <div class="text-center lg:text-left" data-aos="fade-right" data-aos-duration="1000">
             <h1 class="text-5xl md:text-6xl lg:text-7xl font-extrabold mb-6 leading-tight text-white">
                <span class="block">Secangkir Inspirasi,</span>
                <span class="block text-transparent bg-clip-text bg-gradient-to-r from-amber-300 via-amber-400 to-amber-500">Sejuta Cerita.</span>
             </h1>
        ...
        <div class="hidden lg:flex justify-center items-center relative" data-aos="zoom-in" data-aos-duration="1000">
             <img src="<?= UrlHelper::baseUrl('images/coffee.svg') ?>" alt="Ilustrasi Cangkir Kopi Premium" class="relative z-10 w-2/3 max-w-sm drop-shadow-2xl">
             <img src="<?= UrlHelper::baseUrl('images/coffee-cup.svg') ?>" alt="Ilustrasi Biji Kopi" class="absolute -bottom-10 -left-10 w-1/2 opacity-60 z-0">
             <img src="<?= UrlHelper::baseUrl('images/coffee-bean.svg') ?>" alt="Ilustrasi Asap Kopi" class="absolute -top-10 -right-10 w-1/2 opacity-60 z-0">
        </div>
    </div>
</section>
...
<section id="experience" class="section-padding bg-bg-dark-primary">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-12 md:gap-16 items-center">
        <div data-aos="fade-right"> <span class="text-sm font-semibold text-accent-primary uppercase tracking-wider">Ruang Anda</span>
            <h2 class="text-4xl md:text-5xl font-bold my-4 text-white">Lebih dari Kopi, Ini Pengalaman.</h2>
            <p class="text-lg text-text-dark-secondary mb-8 leading-relaxed">
            ...
            <div class="space-y-6">
                <div class="flex items-start space-x-4 p-4 bg-bg-dark-secondary rounded-lg border border-border-dark">
        ...
        <div class="grid grid-cols-2 gap-4 lg:gap-6" data-aos="fade-left" data-aos-delay="100"> <?php
                ...
                $placeholder = UrlHelper::baseUrl('images/menu-placeholder.jpg');
            ?>
            <img src="<?= $img1 ?>" alt="Ilustrasi Sudut Nyaman Kafe" class="rounded-lg shadow-lg aspect-square object-cover transform hover:scale-105 transition-transform duration-300 border-2 border-border-dark" onerror="this.onerror=null; this.src='<?= $placeholder ?>';">
            <img src="<?= $img2 ?>" alt="Ilustrasi Barista Meracik Kopi" class="rounded-lg shadow-lg aspect-square object-cover mt-8 lg:mt-10 transform hover:scale-105 transition-transform duration-300 border-2 border-border-dark" onerror="this.onerror=null; this.src='<?= $placeholder ?>';">
            <img src="<?= $img3 ?>" alt="Ilustrasi Acara Komunitas di Kafe" class="rounded-lg shadow-lg aspect-square object-cover transform hover:scale-105 transition-transform duration-300 border-2 border-border-dark" onerror="this.onerror=null; this.src='<?= $placeholder ?>';">
            <img src="<?= $img4 ?>" alt="Ilustrasi Orang Bekerja di Kafe" class="rounded-lg shadow-lg aspect-square object-cover mt-8 lg:mt-10 transform hover:scale-105 transition-transform duration-300 border-2 border-border-dark" onerror="this.onerror=null; this.src='<?= $placeholder ?>';">
        </div>
    </div>
</section>
                            ...
                            <?php foreach ($topItems as $topItem): ?>
                                <?php
                                    $topItemImagePath = !empty($topItem['image_path'])
                                                        ? $topItem['image_path']
                                                        // Langsung panggil helper untuk placeholder
                                ...
                                <div class="swiper-slide h-auto px-1.5 sm:px-2">
                                    <div class="menu-item menu-card bg-bg-dark rounded-lg shadow-lg overflow-hidden group border border-border-dark flex flex-col h-full">
                                        <div class="relative h-52 w-full">
                                            <img src="<?= $topItemImagePath ?>" alt="<?= SanitizeHelper::html($topItem['name']) ?>"
                                                class="h-full w-full object-cover group-hover:scale-105 transition-transform duration-300"
                                                onerror="this.onerror=null; this.src='<?= UrlHelper::baseUrl('images/menu-placeholder.jpg') ?>';"> </div>
                                 ...
                                 <div class="swiper-slide h-auto px-1.5 sm:px-2" data-category="<?= $categorySlug ?>">
                                     <div class="menu-item menu-card bg-bg-dark rounded-lg shadow-lg overflow-hidden group border border-border-dark flex flex-col h-full">
                                        <div class="relative h-48 w-full">
                                             <img src="<?= $imagePath ?>" alt="<?= SanitizeHelper::html($item['name']) ?>"
                                                class="h-full w-full object-cover group-hover:scale-105 transition-transform duration-300"
                                                onerror="this.onerror=null; this.src='<?= UrlHelper::baseUrl('images/menu-placeholder.jpg') ?>';"> </div>
                                        <div class="p-4 sm:p-5 flex flex-col flex-grow">
...
<section id="gallery" class="section-padding overflow-hidden bg-bg-dark-primary">
     <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="columns-2 md:columns-3 lg:columns-4 gap-4 space-y-4" id="image-gallery">
             <div class="gallery-item break-inside-avoid relative overflow-hidden rounded-lg shadow-lg cursor-pointer group" data-aos="fade-up" data-src="<?= UrlHelper::baseUrl('images/experience-illustration-1.jpg') ?>">
                <img src="<?= UrlHelper::baseUrl('images/experience-illustration-1.jpg') ?>" alt="Suasana Interior Kafe" class="w-full h-auto object-cover transform group-hover:scale-110 transition-transform duration-500 ease-in-out">
             ...
             <div class="gallery-item break-inside-avoid relative overflow-hidden rounded-lg shadow-lg cursor-pointer group" data-aos="fade-up" data-aos-delay="50" data-src="<?= UrlHelper::baseUrl('images/experience-illustration-1.jpg') ?>">
                <img src="<?= UrlHelper::baseUrl('images/experience-illustration-1.jpg') ?>" alt="Seni Latte Art Detail" class="w-full h-auto object-cover transform group-hover:scale-110 transition-transform duration-500 ease-in-out">
                 <div class="gallery-overlay"> <i class="fas fa-search-plus"></i> </div>
            </div>
             <div class="gallery-item break-inside-avoid relative overflow-hidden rounded-lg shadow-lg cursor-pointer group" data-aos="fade-up" data-aos-delay="100" data-src="<?= UrlHelper::baseUrl('images/experience-illustration-1.jpg') ?>">
                <img src="<?= UrlHelper::baseUrl('images/experience-illustration-1.jpg') ?>" alt="Area Duduk Outdoor Malam Hari" class="w-full h-auto object-cover transform group-hover:scale-110 transition-transform duration-500 ease-in-out">
                 <div class="gallery-overlay"> <i class="fas fa-search-plus"></i> </div>
            </div>
             <div class="gallery-item break-inside-avoid relative overflow-hidden rounded-lg shadow-lg cursor-pointer group" data-aos="fade-up" data-aos-delay="150" data-src="<?= UrlHelper::baseUrl('images/experience-illustration-1.jpg') ?>">
                <img src="<?= UrlHelper::baseUrl('images/experience-illustration-1.jpg') ?>" alt="Aneka Pastry di Etalase" class="w-full h-auto object-cover transform group-hover:scale-110 transition-transform duration-500 ease-in-out">
                 <div class="gallery-overlay"> <i class="fas fa-search-plus"></i> </div>
            </div>
             </div>
    </div>
...
<section id="testimonials" class="section-padding bg-bg-dark-secondary">
     <div class="container mx-auto px-4 sm:px-6 lg:px-8">
         ...
         <div class="swiper-container-wrapper max-w-4xl mx-auto">
                 ...
                 <div class="swiper-wrapper pb-16">
                     <div class="swiper-slide">
                         <div class="bg-bg-dark rounded-lg shadow-xl p-8 text-center border border-border-dark relative">
                             <img src="<?= UrlHelper::baseUrl('images/experience-illustration-1.jpg') ?>"
                                  ...
                                  <div class="pt-12"> <i class="fas fa-quote-left text-accent-primary text-3xl mb-4 opacity-70"></i>
        ...
        <div class="grid lg:grid-cols-2 gap-16 items-center">
            <div data-aos="fade-right">
                ...
                <div class="space-y-5 mb-8 text-sm">
                 ...
                 <a href="https://maps.app.goo.gl/contohLinkGoogleMaps" target="_blank" rel="noopener noreferrer" class="btn btn-accent inline-flex items-center px-7 py-3 rounded-full font-semibold transition text-base transform hover:scale-105">
                    <i class="fas fa-directions mr-2"></i> Lihat Peta & Arah
                 </a>
            </div>
            <div class="rounded-lg overflow-hidden shadow-xl border-2 border-border-dark" data-aos="zoom-in-left">
                 <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3951.411699338584!2d112.63306781477917!3d-7.956657194268391!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dd628217a8d759b%3A0x6f57e07a614143f6!2sContoh%20Cafe%20Malang!5e0!3m2!1sen!2sid!4v1678886400000!5m2!1sen!2sid" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" title="Peta Lokasi Kafe"></iframe>
            </div>
        </div>
    </div>
</section>