...
-- Dumping database structure for yours_db
CREATE DATABASE IF NOT EXISTS `yours_db` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */;
USE `yours_db`;

-- Dumping structure for table yours_db.cash_drawers
CREATE TABLE IF NOT EXISTS `cash_drawers` (
  ...
  CONSTRAINT `fk_cash_drawers_users` FOREIGN KEY (`user_id`) REFERENCES `yours_db`.`users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Mencatat histori buka tutup laci kasir';

-- Dumping data for table yours_db.cash_drawers: ~0 rows (approximately)

-- Dumping structure for table yours_db.cash_transactions
CREATE TABLE IF NOT EXISTS `cash_transactions` (
  ...
  CONSTRAINT `fk_cash_transactions_drawers` FOREIGN KEY (`drawer_id`) REFERENCES `yours_db`.`cash_drawers` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_cash_transactions_users` FOREIGN KEY (`user_id`) REFERENCES `yours_db`.`users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table yours_db.cash_transactions: ~0 rows (approximately)

-- Dumping structure for table yours_db.categories
...
-- Dumping data for table yours_db.categories: ~5 rows (approximately)
...
-- Dumping structure for table yours_db.menu_items
CREATE TABLE IF NOT EXISTS `menu_items` (
  ...
  CONSTRAINT `fk_menu_items_categories` FOREIGN KEY (`category_id`) REFERENCES `yours_db`.`categories` (`id`) ON UPDATE CASCADE
...
-- Dumping data for table yours_db.menu_items: ~29 rows (approximately)
...
-- Dumping structure for table yours_db.order_items
CREATE TABLE IF NOT EXISTS `order_items` (
  ...
  CONSTRAINT `fk_order_items_menu_items` FOREIGN KEY (`menu_item_id`) REFERENCES `yours_db`.`menu_items` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `fk_order_items_orders` FOREIGN KEY (`order_id`) REFERENCES `yours_db`.`orders` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dumping data for table yours_db.order_items: ~12 rows (approximately)
...
-- Dumping structure for table yours_db.orders
CREATE TABLE IF NOT EXISTS `orders` (
  ...
  CONSTRAINT `fk_orders_tables` FOREIGN KEY (`table_id`) REFERENCES `yours_db`.`tables` (`id`) ON UPDATE CASCADE
...
-- Dumping data for table yours_db.orders: ~2 rows (approximately)
...
-- Dumping structure for table yours_db.payments
CREATE TABLE IF NOT EXISTS `payments` (
  ...
  CONSTRAINT `fk_payments_orders` FOREIGN KEY (`order_id`) REFERENCES `yours_db`.`orders` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `fk_payments_users` FOREIGN KEY (`processed_by_user_id`) REFERENCES `yours_db`.`users` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci AUTO_INCREMENT=30006 COMMENT='Mencatat detail pembayaran';

-- Dumping data for table yours_db.payments: ~2 rows (approximately)
...
-- Dumping structure for table yours_db.settings
...
-- Dumping data for table yours_db.settings: ~7 rows (approximately)
...
-- Dumping structure for table yours_db.tables
...
-- Dumping data for table yours_db.tables: ~5 rows (approximately)
...
-- Dumping structure for table yours_db.users
...
-- Dumping data for table yours_db.users: ~1 rows (approximately)
